...
function AdminAuthorTab() {
  ...
  return (
    <section className="p-4">
      <h2 className="text-2xl font-bold mb-4 text-mint">Authors CRUD Operations</h2>
              ...
              {editingId === author.id ? (
                <>
                  ...
                  <input
                    type="text"
                    value={author.bio}
                    onChange={(e) => handleChange(author.id, 'bio', e.target.value)}
                    className=" text-mint border-mint border-2 font-bold px-2 py-1 rounded"
                  />
                ...
                <>
                  ...
                  <p>
                    <strong>Books:</strong> {author.books ? author.books.map(book => book.title).join(', ') : 'N/A'}
                  </p>
                  <div className="flex gap-2 mt-2">
                    <button
